...
func Test_Fetch(t *testing.T) {
	// Stand up a local server that returns known JSON.
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: http.Header{
					...
					"HeaderKey1": []string{`HeaderVal1 with a " quote and backslash \`},
				},
				RemoteAddr: "ip",
				Proto:      "Proto",
			},
			msgIncludes: []string{
				...
				`"HeaderKey1":["HeaderVal1 with a \" quote and backslash \\"]`,
				`"ip":"ip"`,
				`"protocol":"proto"`,
